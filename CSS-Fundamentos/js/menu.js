 ...
 * @param {Event} - Evento que dispara a função, como 'click' ou 'touchstart'
 ...
 function toggleMenu(event) {
  ...
  // Seleciona o elemnto de navegação pelo seu ID
  const nav = document.getElementById('nav');

  // Adiciona ou remove a classe 'active' no elemnto de navegação, ativando ou desativando o menu
  ...
  // Define o texto do atributo 'aria-label' depedendo do estado do menu (aberto/fechado)
  if (isActive) {
...
//  Adiciona eventos de 'click' e 'tocuhstart' para ativar a função toggleMenu ao interagir com o botão
